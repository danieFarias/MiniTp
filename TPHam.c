...
void* armarM(void *data){
	...
	imprimirAccion(mydata,accion);
	usleep(1000000);
	sem_post(&mydata->semaforos_param.sem_parrilla);
	pthread_exit(NULL);
}
void* cocinar(void *data){
	struct parametro *mydata = data;
	sem_wait(&mydata->semaforos_param.sem_parrilla);
	pthread_mutex_lock(&parrillaMutex);//bloqueo;
	char *accion = "parrilla";
	imprimirAccion(mydata,accion);
	usleep(5000000);
	sem_post(&mydata->semaforos_param.sem_cocinarT);
	pthread_mutex_unlock(&parrillaMutex);//desbloqueo
	pthread_exit(NULL);
}
...
void* cortarLyT(void *data){
	...
	imprimirAccion(mydata,accion);
	usleep(1000000);
	sem_post(&mydata->semaforos_param.sem_cortarLyTT);
	pthread_exit(NULL);
}
void* armarHam(void *data){
	struct parametro *mydata = data;
	sem_wait(&mydata->semaforos_param.sem_cortarLyTT);
...
void* ejecutarReceta(void *i) {
	...
	pthread_data->semaforos_param.sem_parrilla= sem_parrilla;
	pthread_data->semaforos_param.sem_cocinarT = sem_cocinarT;
	pthread_data->semaforos_param.sem_hornearT = sem_hornearT;
	pthread_data->semaforos_param.sem_cortarLyTT =sem_cortarLyTT;
	//pthread_data->semaforos_param.sem_hamLista =sem_hamLista;
...
//	strcpy(pthread_data->pasos_param[4].accion, "parrilla");
//	strcpy(pthread_data->pasos_param[4].ingredientes[0],"medallon");

//	strcpy(pthread_data->pasos_param[5].accion, "hornear");
//	strcpy(pthread_data->pasos_param[5].ingredientes[0],"pan");
	
//	strcpy(pthread_data->pasos_param[6].accion, "cortarLyT");
...
//	strcpy(pthread_data->pasos_param[7].ingredientes[1],"medallones");
...
//	strcpy(pthread_data->pasos_param[7].ingredientes[3],"tomate");
	...
	sem_init(&(pthread_data->semaforos_param.sem_parrilla),0,0);
	sem_init(&(pthread_data->semaforos_param.sem_cocinarT),0,0);
	sem_init(&(pthread_data->semaforos_param.sem_hornearT),0,0);
	sem_init(&(pthread_data->semaforos_param.sem_cortarLyTT),0,0);
	//sem_init(&(pthread_data->semaforos_param.sem_hamLista),0,0);
    ...
    rf = pthread_create(&p1,NULL,armarM,pthread_data);
    rg = pthread_create(&p1,NULL,cocinar,pthread_data);
    rh = pthread_create(&p1,NULL,hornear,pthread_data);
    ri = pthread_create(&p1,NULL,cortarLyT,pthread_data);
    rj = pthread_create(&p1,NULL,armarHam,pthread_data);
   ...
   if(rj){
	...
	sem_destroy(&sem_parrilla);
	sem_destroy(&sem_cocinarT);
	sem_destroy(&sem_hornearT);
	sem_destroy(&sem_cortarLyTT);
	//sem_destroy(&sem_hamLista);
